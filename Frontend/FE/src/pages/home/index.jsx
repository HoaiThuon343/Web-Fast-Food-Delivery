  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5213/api/Category/ViewAllCategorys"
      );
    ...
    <div className="HomePage">
      ...
      <div>
        ...
        >
          <SwiperSlide>
            <img
              src="https://api.popeyes.vn/api/v1/files/10x3fixed.jpg"
              alt=""
            />
          </SwiperSlide>
          <SwiperSlide>
            <img
              src="https://api.popeyes.vn/api/v1/files/MGP8_10x3.jpg"
              alt=""
            />
          </SwiperSlide>
          <SwiperSlide>
            <img
              src="https://api.popeyes.vn/api/v1/files/KVCajunCheese_10x3.jpg"
              alt=""
            />
          </SwiperSlide>
        </Swiper>
      ...
      {/* <Carousel autoplay /> */}
      {!search ? (
    (dataCategory || []).map((item) => ( // Thêm (dataCategory || []) để an toàn hơn
      <div className="menu-row" key={item.categoryId}>
            <h2>
