...
### Front-End Setup
1. For front-end developers, run the program and navigate to [http://localhost:5213/swagger/index.html](http://localhost:5213/swagger/index.html) to view the Swagger UI with all API links.
